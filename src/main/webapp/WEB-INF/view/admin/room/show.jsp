					...
					<div class="main-content">
						<div class="main-content-inner">
							...
							<div class="page-content">
								...
								<div class="row">
									<div class="col-xs-12">
										<form id="deleteForm" method="post" action="/admin/room/delete/confirm">
														...
														<c:forEach var="room" items="${rooms}">
															<tbody>
																<tr class="">
																	...
																	<td>${room.status}</td>
																	<td><img src="/images/room/${room.image}"
										...
										<nav aria-label="Page navigation">
											<ul class="pagination">
												<li class="${currentPage eq 1 ? 'disabled' : ''}">
													<a
														href="${currentPage gt 1 ? '/admin/room?page=' += (currentPage-1) : ''}">&laquo;</a>
												</li>
												<c:forEach begin="1" end="${totalPages}" var="i">
													<li class="${i eq currentPage ? 'active' : ''}">
														<a href="/admin/room?page=${i}">${i}</a>
													</li>
												</c:forEach>
												<li class="${currentPage eq totalPages ? 'disabled' : ''}">
													<a
														href="${currentPage lt totalPages ? '/admin/room?page=' += (currentPage+1) : ''}">&raquo;</a>
												</li>
											</ul>
										</nav>
