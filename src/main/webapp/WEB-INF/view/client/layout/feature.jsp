<%@page contentType="text/html" pageEncoding="UTF-8" %>
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
            <div class="video-area video-bg pt-200 pb-200" data-background="/client/img/service/video-bg.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-12">
                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-6 col-lg-6">
                            <div class="support-location-img mb-50">
                                <img src="/client/img/service/support-img.jpg" alt="">
            ...
            <div class="testimonial-area testimonial-padding"
                data-background="/client/img/testmonial/testimonial_bg.jpg">
                <div class="container ">
                                ...
                                <div class="single-testimonial text-center">
                                    ...
                                    <div class="testimonial-caption ">
                                        <div class="testimonial-top-cap">
                                            <img src="/client/img/icon/testimonial.png" alt="">
                                        ...
                                        <div
                                            ...
                                            <div class="founder-img">
                                                <img src="/client/img/testmonial/Homepage_testi.png" alt="">
                                            </div>
                    ...
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6">
                            <div class="home-blog-single mb-30">
                                <div class="blog-img-cap">
                                    <div class="blog-img">
                                        <img src="/client/img/blog/home-blog1.jpg" alt="">
                                    </div>
                                    <div class="blog-cap">
                                        <p> | Traveling</p>
                                        <h3><a href="single-blog.html">Tips For Taking A Long-Term Trip With
                                                Kids.</a></h3>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6">
                            <div class="home-blog-single mb-30">
                                <div class="blog-img-cap">
                                    <div class="blog-img">
                                        <img src="/client/img/blog/home-blog2.jpg" alt="">
                                    </div>
                                    <div class="blog-cap">
                                        <p> | Traveling</p>
                                        <h3><a href="single-blog.html">Tips For Taking A Long-Term Trip With
